...
/*
        DiscordWebhook webhook = new DiscordWebhook("https://discord.com/api/webhooks/WEBHOOK_ID/TOKEN");
        webhook.setContent("새로운 글이 작성되었습니다.");
        webhook.addEmbed(new DiscordWebhook.EmbedObject()
                .setTitle(requestDto.getTitle())
                .setDescription(requestDto.getContent())
